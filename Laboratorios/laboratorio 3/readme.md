...
| ------------------------------- | -------------------------- | -------------------------- | -------------------------- |
| Reposo                          | <img src="resultados_lab3/antebrazo_reposo_original.png" width="867" alt="antebrazo_reposo_original"> | <img src="resultados_lab3/antebrazo_reposo_filtrada.png" width="867" alt="antebrazo_reposo_filtrada"> | **Colocar aquí la imagen** | 
